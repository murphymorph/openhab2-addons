...
/**
 * Test for Homeduino switch3 messages
 *
 * @author Martin van Wingerden - Initial contribution
 */
public class Switch3MessageTest {
    ...
    public void testOutgoingMessage() throws Exception {
        AbstractHomeduinoMessage msg = HomeduinoMessageFactory.createMessage(PacketType.SWITCH3);
        msg.setDeviceId("25.16");
        msg.convertFromState(HomeduinoValueSelector.COMMAND, OnOffType.OFF);
    ...
    public void testIncomingMessage() throws Exception {
        ...
        HomeduinoMessage event = TestHelper.getInterpretation(rfEvent, PacketType.SWITCH3);

        Assert.assertEquals(PacketType.SWITCH3, event.getPacketType());
